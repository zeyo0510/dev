    ...
    public partial class Sniffer : Form
    {
        ...
        private bool StartReceiving()
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Cannot listen on " + networkInterfaces[index].Name, "Connection error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return false;
                }
            }
        ...
        {
          Invoke(new refresh(OnRefresh), p);
        }
        ...
        private void ExportPacketsAsText()
        {
            ...
            {
                MessageBox.Show("No packets to export", "Export packets as text", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void ExportSelectedPacketAsBinary()
        {
            ...
            {
                MessageBox.Show("Select one packet", "Export packet bytes", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void ExportPacketsAsCsv()
        {
            ...
            {
                MessageBox.Show("No packets to export", "Export packets as CSV", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        {
          SetSelectedRow(DGV.CurrentRow != null ? DGV.CurrentRow.Index - 1 : 0);
        }
