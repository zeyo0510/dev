  ...
  public partial class OptionsDialog : Form
  {
    ...
    private void Options_Load(object sender, EventArgs e)
    {
      ...
      foreach (ListViewItem listViewItem in Properties.Settings.Default.diskDrives)
        this.drivesListView.Items.Add(listViewItem.Clone() as ListViewItem);
      ...
      this.checkBoxSystem.Checked = Properties.Settings.Default.searchSystem;
           ...
           if (Properties.Settings.Default.findFilesMode == 0) this.radioButtonFindCreated.Checked = true;
      else if (Properties.Settings.Default.findFilesMode == 1) this.radioButtonFindModified.Checked = true;
      else if (Properties.Settings.Default.findFilesMode == 2) this.radioButtonFindAccessed.Checked = true;
      ...
      this.checkBoxZeroLength.Checked = Properties.Settings.Default.searchZeroByte;
           ...
           if (Properties.Settings.Default.filterMode == 0) this.radioButtonFilterSafe.Checked = true;
      else if (Properties.Settings.Default.filterMode == 1) this.radioButtonFilterMed.Checked = true;
      else if (Properties.Settings.Default.filterMode == 2) this.radioButtonFilterAgg.Checked = true;
      ...
      // Removal
           if (Properties.Settings.Default.removeMode == 0) this.radioButtonRemove.Checked = true;
      else if (Properties.Settings.Default.removeMode == 1) this.radioButtonRecycle.Checked = true;
      else if (Properties.Settings.Default.removeMode == 2) this.radioButtonMove.Checked = true;
    ...
    {
           if (this.radioButtonFilterSafe.Checked == true) this.textBoxSearchFilters.Text = "*.tmp; *.temp; *.gid; *.chk; *.~*;";
      else if (this.radioButtonFilterMed.Checked == true) this.textBoxSearchFilters.Text = "*.tmp; *.temp; *.gid; *.chk; *.~*;*.old; *.fts; *.ftg; *.$$$; *.---; ~*.*; *.??$; *.___; *._mp; *.dmp; *.prv; CHKLIST.MS; *.$db; *.??~; *.db$; chklist.*; mscreate.dir;";
      else if (this.radioButtonFilterAgg.Checked == true) this.textBoxSearchFilters.Text = "*.tmp; *.temp; *.gid; *.chk; *.~*;*.old; *.fts; *.ftg; *.$$$; *.---; ~*.*; *.??$; *.___; *._mp; *.dmp; *.prv; CHKLIST.MS; *.$db; *.??~; *.db$; chklist.*; mscreate.dir;*.wbk; *log.txt; *.err; *.log; *.sik; *.bak; *.ilk; *.aps; *.ncb; *.pch; *.?$?; *.?~?; *.^; *._dd; *._detmp; 0*.nch; *.*_previous; *_previous;";
    ...
    {
      // Drives
      Properties.Settings.Default.diskDrives = new System.Collections.ArrayList(this.drivesListView.Items);

      // Searching
           if (this.radioButtonFilterSafe.Checked) Properties.Settings.Default.filterMode = 0;
      else if (this.radioButtonFilterMed.Checked) Properties.Settings.Default.filterMode = 1;
      else if (this.radioButtonFilterAgg.Checked) Properties.Settings.Default.filterMode = 2;
      ...
      Properties.Settings.Default.searchSystem = this.checkBoxSystem.Checked;
            ...
            if (this.radioButtonFindCreated.Checked) Properties.Settings.Default.findFilesMode = 0;
      else if (this.radioButtonFindModified.Checked) Properties.Settings.Default.findFilesMode = 1;
      else if (this.radioButtonFindAccessed.Checked) Properties.Settings.Default.findFilesMode = 2;
      ...
      // Removal
           if (this.radioButtonRemove.Checked) Properties.Settings.Default.removeMode = 0;
      else if (this.radioButtonRecycle.Checked) Properties.Settings.Default.removeMode = 1;
      else if (this.radioButtonMove.Checked) Properties.Settings.Default.removeMode = 2;
