...
namespace Little_Disk_Cleaner
{
    ...
    public partial class CrashReporter : Form
    {
        ...
        private void GenerateDialogReport(Exception e)
        {
            ...
            sb.AppendLine(string.Format("Build Date: {0}", Properties.Settings.Default.buildTime));
            // os info
        ...
        private bool SendBugReport() 
        {
            ...
            HttpWebRequest webrequest = (HttpWebRequest)HttpWebRequest.Create(Properties.Settings.Default.crashReportURI);
