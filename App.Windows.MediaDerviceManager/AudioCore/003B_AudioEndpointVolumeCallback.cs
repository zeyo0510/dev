...
namespace AudioCore
{
  internal class AudioEndpointVolumeCallback : IAudioEndpointVolumeCallback
  {
    ...
    /************************************************/
    [PreserveSig]
    public int OnNotify(IntPtr notify)
    {
      AUDIO_VOLUME_NOTIFICATION_DATA _AUDIO_VOLUME_NOTIFICATION_DATA_ = (AUDIO_VOLUME_NOTIFICATION_DATA)Marshal.PtrToStructure(notify, typeof(AUDIO_VOLUME_NOTIFICATION_DATA));
      /************************************************/
      IntPtr intPtr = Marshal.OffsetOf(typeof(AUDIO_VOLUME_NOTIFICATION_DATA), "ChannelVolume");
      IntPtr ptr = (IntPtr)((long)notify + (long)intPtr);
