...
namespace AudioCore
{
  public class AudioClient : IDisposable
  {
    ...
    /************************************************/
    internal AudioClient(IAudioClient obj)
    {
      this._AudioClient_ = obj;
    }
    /************************************************/
    public int BufferSize
    {
      get
      {
        uint retValue;
        /************************************************/
        Marshal.ThrowExceptionForHR(this._AudioClient_.GetBufferSize(out retValue));
        /************************************************/
        return (int)retValue;
      }
    }
    ...
    public int CurrentPadding
    {
      get
      {
        int retValue;
        /************************************************/
        Marshal.ThrowExceptionForHR(this._AudioClient_.GetCurrentPadding(out retValue));
        /************************************************/
        return retValue;
      }
    }
    ...
    public void Start()
    {
      this._AudioClient_.Start();
    }
    /************************************************/
    public void Stop()
    {
      this._AudioClient_.Stop();
    }
