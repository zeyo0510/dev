...
{
    class DosHeaderFiller : AbstractFiller, IContentFiller
    {   
        public DosHeaderFiller(ContentDataGridView dataGridView) : base(dataGridView) {}
        ...
        public void FillContent(PEFile peFile)
        {
            ...
            // fill the columns
            foreach (IPeElem elem in peFile.DosHeader)
            {
                ...
                dataGridView.Rows[rowIndex].Cells[0].ToolTipText = peFile.DosHeader.GetDescription(elem.Name);
            }
        ...
        {
            // add e_magic as string
            dataGridView.Rows[0].Cells[4].Value = peFile.DosHeader.E_magic.NumValAsAscii();
        }
    }
}
