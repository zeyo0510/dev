// https://github.com/naudio/NAudio/blob/main/src/NAudio.Core/Wave/WaveFormats/WaveFormat.cs
/************************************************/
...
namespace AudioCore
{
  ...
  public class WaveFormat
  {
    ...
    public WaveFormat(BinaryReader reader)
    {
      ...
      waveFormatTag = (WaveFormatEncoding)reader.ReadUInt16();
      _Channels = reader.ReadInt16();
      _SampleRate = reader.ReadInt32();
      _AverageBytesPerSecond = reader.ReadInt32();
      _BlockAlign = reader.ReadInt16();
      _BitsPerSample = reader.ReadInt16();
      if (num > 16)
      {
        _ExtraSize = reader.ReadInt16();
