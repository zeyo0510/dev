        ...
        var drawStart = function(event) {
            ...
            switch (state.tool) {
                ...
                case TOOLS.PEN:
                    ...
                    points = [{x: state.startDrawX, y: state.startDrawY}];
                    canvas.current.context.shadowColor = 'transparent';
...
//                        currentObject.draw(canvas.current.context);
                    ...
                    case TOOLS.TEXTARROW:
                        ...
                        currentObject.xb1Last = currentObject.xb1 = state.startDrawX - 138;
...
//            }
        ...
        this.setToolsWigth = function(w) {
            ...
            chrome.storage.local.set({
                'setting': JSON.stringify(LS.setting)
            }, function() {});
        };
