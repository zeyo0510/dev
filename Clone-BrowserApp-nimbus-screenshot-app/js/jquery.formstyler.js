                ...
                el.css({position: 'absolute', left: -9999}).each(function() {
                    if (el.next('span.jq-checkbox').length < 1) {
                        ...
                        el.on('refresh', function() {
                            if (el.is(':checked')) checkbox.addClass('checked'); else checkbox.removeClass('checked');
                            if (el.is(':disabled')) checkbox.addClass('disabled'); else checkbox.removeClass('disabled');
                        });
                    }
                });
                ...
                el.css({position: 'absolute', left: -9999}).each(function() {
                    if (el.next('span.jq-radio').length < 1) {
                        ...
                        el.on('refresh', function() {
                            ...
                            if (el.is(':disabled')) radio.addClass('disabled'); else radio.removeClass('disabled');
                        });
                    }
                });
                ...
                el.css({position: 'absolute', top: '-50%', right: '-50%', fontSize: '200px', opacity: 0}).each(function() {
                    if (el.parent('span.jq-file').length < 1) {
                        ...
                        el.change(function() {
                            ...
                            .on('refresh', function() {
                                if (el.is(':disabled')) file.addClass('disabled'); else file.removeClass('disabled');
                            })
                    }
                });
                ...
                el.each(function() {
                    if (el.next('span.jqselect').length < 1) {
                        ...
                        function selectbox() {
                            ...
                            // одиночный селект
                            function doSelect() {
                                var selectbox = $('<span' + id + ' class="jq-selectbox jqselect' + cl + '" style="display: inline-block; position: relative; z-index:' + opt.singleSelectzIndex + '">' + '<div class="select" style="float: left"><div class="text"></div>' + '<b class="trigger"><i class="arrow"></i></b>' + '</div>' + '</span>');
                                ...
                                if (el.is(':disabled')) {
                                    ...
                                    makeList();
                                    var dropdown = $('<div class="dropdown" style="position: absolute; overflow: auto; overflow-x: hidden">' + '<ul style="list-style: none">' + list + '</ul>' + '</div>');
...
//                                        var className = jQuery('.dropdown li.sel').attr('class');
//                                        className = className.split(' ');
//                                        var tmp;
//                                        for (var i in className) {
//                                            if (className[i].length === 2) {
//                                                tmp = className[i];
//                                                break;
//                                            }
//                                        }
//                                        $('.jq-selectbox.jqselect div.text').removeAttr('class').addClass(tmp + ' text');
                                    });
...
jQuery(function() {
    setTimeout(function() {
        jQuery('.jq-selectbox').each(function() {
            var className = jQuery('.dropdown li.sel', this).attr('class');
            className = className.replace('selected sel', '');
            $('div.text', this).addClass(className);
        });
    }, 100);
});