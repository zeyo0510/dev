...
<x-menuitem>
  ...
  <x-menu>
    ...
    <x-menuitem value="elementsPanel" togglable>
...
<x-menuitem id="dev-menu-item" hidden>
  <x-label>Develop</x-label>

  <x-menu>
    <x-menuitem value="reloadWindow">
      <x-label>Reload</x-label>
      <x-shortcut class="default-shortcut" value="Control+R"></x-shortcut>
      <x-shortcut class="user-shortcut"></x-shortcut>
    </x-menuitem>

    <hr/>

    <x-menuitem value="inspectWindow">
